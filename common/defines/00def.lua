...
NDefines.NDiplomacy.HRE_AUTHORITY_JOIN_EMPIRE = 10
...
NDefines.NEconomy.GOLD_MINE_DEPLETION_THRESHOLD = 15				-- Gold mines above production level or above can be depleted
...
NDefines.NMilitary.WARGOAL_MAX_BONUS = 60
